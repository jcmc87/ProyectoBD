 ...
 * - Formulario de acceso con correo/usuario y contraseña conectado a Supabase Auth.
 * - Conmutador de tema Claro / Oscuro.
 * - Validación y redirección según el rol ('admin' al Dashboard, 'usuario' a Registrar Ingreso).
 */
export const Login: React.FC = () => {
  ...
  /**
   * Maneja el envío del formulario de login contra Supabase Auth.
